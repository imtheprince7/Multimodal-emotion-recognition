...
def cut_video(input_path, output_path, start_time, end_time):
    ...
    # Get the frame rate and calculate the start and end frame numbers
...
path='dataset_label\\completeData.csv'
df=pd.read_csv(path)
labels=df['emotion']
s=df['start_time']
e=df['end_time']
...
for i in range(len(s)):
    input_path = 'dataSet\\video'+filename[i]+'.avi'
    output_path = 'splitData\\videoSplit\\'+str(i)+'_'+labels[i]+'_.avi'
